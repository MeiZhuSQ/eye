...
public class FileUploadUtils {
    ...
    public static final FileItemInfo upload(String baseDir, MultipartFile file)
        ...
        // fixed by liupengfei 20220208
        FileItemInfo fileItemInfo = new FileItemInfo(fileName, String.valueOf(file.hashCode()), file.getSize(), file.getContentType(), new Date(), FileItemInfo.ServerType.LOCAL.getServerType(), "/profile" + "/" + "images" + "/" + fileName);
